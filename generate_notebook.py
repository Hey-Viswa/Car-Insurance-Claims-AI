"""Generates the clean Colab notebook for the 4-phase ML pipeline."""
import json
import os
...
out_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "notebooks", "Car_Insurance_Claims_Master_Colab.ipynb")
